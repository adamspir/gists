...
create (:Service:Rest{Endpoint:'https://kumquat-v1.production.api.e-travel.gr/api-v1.0/en/insurance_contracts?email=services@pamediakopes.gr&password=wtf_flights',name:'kumquat_api_insurance_production'});
create (:Service:Rest{Endpoint:'http://kumquat-v1.staging.api.e-travel.gr/api-v1.0/en/insurance_contracts?email=services@pamediakopes.gr&;password=wtf_flights',name:'kumquat_api_insurance_staging'});
...
match (a:Service{name:'AWS redrive'}), (b:Service{name:'kumquat_api_insurance_production'})
create (a)-[SENDS_TO]->(b);

match (a:Service{name:'AWS redrive'}), (b:Service{name:'kumquat_api_insurance_staging'})
create (a)-[SENDS_TO]->(b);
...
match (a:ScheduledTask{name:'insurance_cli_new'}), (b:Service{name:'mail_to_customers'})
create (a)-[SENDS_TO]->(b);
...
match (a:Service{name:'AWS redrive'}), (b:Service{name:'kumquat_api_cars_production'})
create (a)-[SENDS_TO]->(b);
